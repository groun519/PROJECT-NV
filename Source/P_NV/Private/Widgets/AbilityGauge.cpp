...
void UAbilityGauge::NativeOnListItemObjectSet(UObject* ListItemObject)
{
	...
	float CooldownDuration = UNVAbilitySystemStatics::GetStaticCooldownDurationForAbility(AbilityCDO);
	float Cost = UNVAbilitySystemStatics::GetStaticCostForAbility(AbilityCDO);
